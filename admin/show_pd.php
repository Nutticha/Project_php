...
<body class="w3-light-grey w3-content" style="max-width:1600px">
        ...
        <table width="800" border="0" bgcolor="#FFFFFF" align = "center" >
            ...
            <?php while($row = $result->fetch_assoc()): ?>
                ...
                <td align="center"> <a href="edit_pd.php?id=$row[0]" class="btn btn-warning">Edit</a></td>
                <td align="center"> <a href="delete_pd.php?id=$row[0]" class="btn btn-danger ">Delete</a></td>
                </tr>
                <?php endwhile ?>
